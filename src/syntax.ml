...
let rec print_t = function
  ...
  | LE (t1, t2) ->
    ...
    print_string ")"
  | If (t1, t2, t3) ->
    print_string "If("; print_t t1; print_string ", "; print_newline ();
    print_t t2; print_string ", "; print_newline ();
  ...
  | Let ((id, typ), t1, t2) ->
    ...
    Type.print_t typ;
    print_string "), ";
    print_t t1; print_string ", "; print_newline ();
    print_t t2; print_string ")"
  ...
  | LetTuple (args, t1, t2) ->
    let rec print_args args =
      ...
      | [] -> ()
      | (id, typ) :: [] ->
        print_string id; print_string ", "; Type.print_t typ
      | (id, typ) :: tl ->
        print_string id; print_string ", "; Type.print_t typ;
        print_args tl
    in
    print_string "LetTuple(";
    print_string "("; print_args args; print_string ")";
    print_t t1; print_string ", ";
    print_t t2; print_string ")"
  | Array (t1, t2) ->
    print_string "Array(";
...
and print_fundef ({ name; args; body }) =
  let (id, typ) = name in
  print_string "{";
  print_string "("; print_string id;  Type.print_t typ; print_string "); ";
  print_string "["; List.iter begin fun arg ->
    let (id, typ) = arg in
    print_string id; print_string ", "; Type.print_t typ;
  end args;
  print_t body;
...
and print_t_list ts =
  ...
  let rec loop ts =
    ...
    | [] -> ()
    | hd :: [] -> print_t hd
    | hd :: tl -> print_t hd; print_string "; "; loop tl
  in loop ts;
  print_string "]"
